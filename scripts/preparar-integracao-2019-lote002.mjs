...
const analises = [
  ...
  { unidade: 16, blocos: [
    ['Consultar e reservar viagem em agência', 'contexto_util_nao_publicado', ['A2-L15-0832-01', 'B1-L15-0836-01']],
    ['Informar partidas e chegadas por horário', 'ja_coberto_integralmente', ['A2-L5-0128-02', 'A1-GRAM-0005']],
    ['Contrastar weekdays e weekend ao explicar disponibilidade', 'ja_coberto_com_exemplos_equivalentes', ['A1-GRAM-0015', 'A2-GRAM-0007']],
    ['Combinar programa e prometer retorno com will', 'ja_coberto_com_exemplos_equivalentes', ['A2-L3-0055-01', 'A2-L15-0829-01']],
    ['Reagir a trem perdido e prever atraso de voo', 'contexto_util_nao_publicado', ['B1-L6-0201-02', 'A2-L5-0128-02']],
    ['Perguntar e informar chegada no passado', 'ja_coberto_com_exemplos_equivalentes', ['A2-L9-0448-01', 'A2-L15-0829-01']],
    ['Avaliar viagem passada e relatar problemas', 'contexto_util_nao_publicado', ['A2-L10-1377-01', 'B1-L15-0844-01']],
  ]},
  { unidade: 17, blocos: [
    ['Relatar objeto perdido com present perfect e passado simples', 'ja_coberto_com_exemplos_equivalentes', ['B1-L15-0844-01', 'A2-L15-0829-01']],
    ['Escolher presente perguntando preço e comparando opções', 'contexto_util_nao_publicado', ['A2-L4-0068-03', 'A2-L15-0832-01']],
    ['Expressar excesso e suficiência com too e enough', 'ja_coberto_integralmente', ['A2-L14-0762-01', 'B2-L6-0237-02']],
    ['Perguntar tamanho, material e adequação de roupa', 'ja_coberto_com_exemplos_equivalentes', ['A2-L5-0128-05', 'A2-L15-0823-01']],
    ['Registrar e recuperar item em achados e perdidos', 'contexto_util_nao_publicado', ['A2-L15-0832-01', 'B1-L15-0836-01']],
    ['Perguntar onde e quando um item foi perdido', 'ja_coberto_com_exemplos_equivalentes', ['A2-L5-0166-01', 'B1-L15-0844-01']],
    ['Resolver trocas sucessivas de presentes e objetos', 'conteudo_sem_objetivo_independente', ['A2-L10-1377-01']],
  ]},
  { unidade: 18, blocos: [
    ['Perguntar e explicar razões com why e because', 'ja_coberto_integralmente', ['A2-L5-0169-01', 'A2-L6-0199-02']],
    ['Justificar preferências por animais e características', 'ja_coberto_com_exemplos_equivalentes', ['A2-L15-0829-01', 'A2-L15-0823-01']],
    ['Escolher objeto por tamanho, preço e aparência', 'contexto_util_nao_publicado', ['A2-L14-0762-01', 'A2-L4-0068-03']],
    ['Especificar objeto desejado com which', 'ja_coberto_com_exemplos_equivalentes', ['A2-L7-0262-01', 'B1-L7-0262-02']],
    ['Reclamar de quarto e pedir substituição de item', 'contexto_util_nao_publicado', ['A2-L15-0832-01', 'B2-L6-0173-02']],
    ['Ligar e desligar luz, rádio e aparelho', 'ja_coberto_integralmente', ['A2-L5-0119-01']],
    ['Contrastar mesmo tamanho e cor diferente', 'ja_coberto_com_exemplos_equivalentes', ['B1-L6-0237-01', 'A2-L15-0823-01']],
  ]},
  { unidade: 19, blocos: [
    ['Expressar necessidade com need e some', 'ja_coberto_integralmente', ['A2-L7-0312-01', 'A1-GRAM-0021']],
    ['Perguntar e dizer preferência para refeição com would like', 'ja_coberto_integralmente', ['B1-L6-0230-01', 'A2-L15-0823-01']],
    ['Comprar alimentos escolhendo tipo, tamanho e quantidade', 'contexto_util_nao_publicado', ['A2-L15-0823-01', 'A2-L4-0068-03']],
    ['Escolher vinho e localizar loja próxima', 'contexto_util_nao_publicado', ['A2-L4-0111-01', 'A2-L15-0832-01']],
    ['Receber convidado e oferecer bebida antes do jantar', 'contexto_util_nao_publicado', ['A2-L10-1377-01', 'B1-L15-0836-01']],
    ['Perguntar e prever quando a refeição estará pronta', 'ja_coberto_com_exemplos_equivalentes', ['A2-L3-0055-01', 'A2-L5-0128-02']],
    ['Nomear partes do corpo em sequência humorística', 'conteudo_sem_objetivo_independente', ['A2-L15-0823-01']],
  ]},
  { unidade: 20, blocos: [
    ['Descrever rotina de trabalho com advérbios de frequência', 'ja_coberto_integralmente', ['A2-L6-0201-01', 'A2-L15-0829-01']],
    ['Oferecer bebida e declarar preferência habitual', 'ja_coberto_com_exemplos_equivalentes', ['B1-L3-0055-04', 'A2-L15-0823-01']],
    ['Convidar para jantar e negociar outro dia', 'contexto_util_nao_publicado', ['A2-L10-1377-01', 'A2-L15-0829-01']],
    ['Narrar sequência policial no passado simples', 'ja_coberto_com_exemplos_equivalentes', ['A2-L8-0352-01', 'B1-L15-0844-01']],
    ['Contrastar hábito passado e acontecimento pontual', 'ja_coberto_com_exemplos_equivalentes', ['B1-L15-0844-01', 'A2-L6-0201-01']],
    ['Perguntar e relatar viagem, compras e produção no passado', 'contexto_util_nao_publicado', ['A2-L15-0829-01', 'A2-L10-1377-01']],
  ]},
  { unidade: 21, blocos: [
    ['Expressar prazer em atividades com enjoy mais gerúndio', 'ja_coberto_integralmente', ['A2-L8-0350-01', 'B1-L8-0350-02']],
    ['Contrastar desempenho habitual e desempenho atual no esporte', 'ja_coberto_com_exemplos_equivalentes', ['A2-L6-0201-01', 'B1-L6-0237-01']],
    ['Avaliar habilidade e desempenho com good at, well e badly', 'ja_coberto_com_exemplos_equivalentes', ['A2-L15-0829-01', 'B1-L6-0237-01']],
    ['Relatar lesão esportiva e responsabilidade no passado', 'contexto_util_nao_publicado', ['B1-L15-0844-01', 'A2-L15-0823-01']],
    ['Pedir sanduíche e bebida com would like', 'ja_coberto_com_exemplos_equivalentes', ['B1-L6-0230-01', 'A2-L15-0823-01']],
    ['Preparar jantar de aniversário e negociar ingredientes', 'contexto_util_nao_publicado', ['A2-L10-1377-01', 'A2-L15-0823-01']],
  ]},
  { unidade: 22, blocos: [
    ['Perguntar e informar profissão', 'ja_coberto_com_exemplos_equivalentes', ['A2-L15-0829-01', 'A1-GRAM-0009']],
    ['Identificar pessoa por roupa e companhia', 'ja_coberto_com_exemplos_equivalentes', ['A2-L15-0823-01', 'B1-L3-0053-03']],
    ['Apresentar pessoas e conversar sobre trabalho em festa', 'contexto_util_nao_publicado', ['A1-L5-0168-04', 'A2-L10-1377-01']],
    ['Perguntar por sintomas e expressar mal-estar', 'ja_coberto_com_exemplos_equivalentes', ['A2-L15-0829-01', 'A2-L7-0312-01']],
    ['Localizar pessoa descrevendo roupa e objeto na mão', 'contexto_util_nao_publicado', ['A2-L15-0823-01', 'A2-L14-0742-01']],
    ['Oferecer comida e bebida e declarar fome ou sede', 'ja_coberto_com_exemplos_equivalentes', ['B1-L6-0230-01', 'A2-L15-0823-01']],
    ['Dar medicamento e prever melhora', 'contexto_util_nao_publicado', ['A2-L9-0422-01', 'A2-L3-0055-01']],
  ]},
  { unidade: 23, blocos: [
    ['Negociar programa de fim de semana com would like e shall', 'ja_coberto_com_exemplos_equivalentes', ['B1-L6-0230-01', 'B1-L3-0055-04']],
    ['Orientar manobra e estacionamento com can e imperativo', 'contexto_util_nao_publicado', ['A1-VERB-0001', 'A2-L14-0742-01']],
    ['Explicar regras de museu com can not e have to', 'ja_coberto_integralmente', ['A1-VERB-0002', 'B1-L4-0110-02']],
    ['Usar chapelaria e perguntar entrada e fotografia', 'contexto_util_nao_publicado', ['A2-L15-0832-01', 'A2-L10-0466-01']],
    ['Dar instruções para operar câmera', 'ja_coberto_com_exemplos_equivalentes', ['B1-L6-0173-01', 'A2-L5-0119-01']],
    ['Distinguir estacionamento gratuito e pago por dia', 'contexto_util_nao_publicado', ['A1-GRAM-0015', 'B1-L4-0110-02']],
  ]},
  { unidade: 24, blocos: [
    ['Planejar ida ao litoral com shall, let us e want', 'ja_coberto_com_exemplos_equivalentes', ['B1-L3-0055-04', 'A2-L7-0287-01']],
    ['Comparar meios de transporte por preço e velocidade', 'ja_coberto_com_exemplos_equivalentes', ['B1-L6-0237-01', 'A2-L9-0416-01']],
    ['Pedir direções e informar distância rodoviária', 'ja_coberto_integralmente', ['A2-L4-0111-01', 'A1-L4-1521-03']],
    ['Escolher como chegar à praia por caminhada, ônibus ou táxi', 'contexto_util_nao_publicado', ['A2-L9-0416-01', 'A2-L14-0742-01']],
